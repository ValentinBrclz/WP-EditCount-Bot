...
/////////////////////////
/// CONSTANTS
var TEMPLATE = "Compteur d'édition automatique";
...
/////////////////////////
/// MAIN
getPagesTranscludedBy("Modèle:"+TEMPLATE, function (err, data) {
	if (err) {
		console.error(err);
		return;
	}
...
/**
 * Gets the list of pages that transclude the given pages
 * @see https://www.mediawiki.org/wiki/API:Transcludedin
 * @param {String} template - the transcluded template
 * @param callback
 */
function getPagesTranscludedBy(template, callback) {
	client.getAll(
		{
			action: 'query',
			prop: 'transcludedin',
...
/**
 * Get the first item in an object
